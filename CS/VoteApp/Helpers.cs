...
namespace DevExpress.VoteApp {
    public class Helpers {
        //public const string USMap = "usa.shp";
        public const string USMap = "USAStates.shp";
        public const string USCountyMap = "USACounties.shp";// cb_2015_us_county_20m.shp";
    ...
    public class VoteHelpers {
        ...
        public const string US2016Results = @"US2016Results_Fake.json";
